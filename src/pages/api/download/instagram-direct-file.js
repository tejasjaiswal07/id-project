/**
 * DEPRECATED: Instagram Direct File Download Endpoint (Legacy)
 *
...
async function handler(req, res) {
  console.warn('[DEPRECATED] Legacy Instagram direct file download endpoint called. Please migrate to /api/download/optimized');
  captureMessage(
    'Deprecated API endpoint used',
    'warning',
    {
      endpoint: '/api/download/instagram-direct-file',
      url: req.body?.url,
