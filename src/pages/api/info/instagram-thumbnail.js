/**
 * DEPRECATED: Instagram Thumbnail Info Endpoint (Legacy)
 *
...
async function handler(req, res) {
  console.warn('[DEPRECATED] Legacy Instagram thumbnail info endpoint called. Please migrate to /api/info/enhanced');
  captureMessage(
    'Deprecated API endpoint used',
    'warning',
    {
      endpoint: '/api/info/instagram-thumbnail',
