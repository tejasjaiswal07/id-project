/**
 * DEPRECATED: Instagram Info Endpoint (Legacy)
 *
...
async function handler(req, res) {
  console.warn('[DEPRECATED] Legacy Instagram info endpoint called. Please migrate to /api/info/enhanced');
  captureMessage(
    'Deprecated API endpoint used',
    'warning',
    {
      endpoint: '/api/info/instagram',
